...
コメント allowlist、R1 / R2、昇格 — を守れるかを確認します。規範の正典は
...
- Expected QA Behavior (round のフィールド: Intent Delta / R2 / Transferable Principles / Verdict)
...
- [transferable-principle-skip](cases/transferable-principle-skip.md) — reflection の skip 防止
